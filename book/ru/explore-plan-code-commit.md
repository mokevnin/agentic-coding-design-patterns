...
2. Начните с исследования: «Прочитай файлы, отвечающие за X, и разберись, как
   устроено Y». Затем попросите план решения и проговорите ограничения,
   которых не видно в коде.
...
> Составь план исправления. Учти, что формат файла менять нельзя — его читают
> внешние интеграции.
