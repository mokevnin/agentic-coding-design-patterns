...
2. Начните с исследования: «Прочитай файлы, отвечающие за X, и разберись, как
   устроено Y». Затем попросите план решения.
...
Разработчик включает режим планирования — до утверждения плана агент не сможет
менять файлы, и запрещать код в промптах не нужно.

**Исследование:**

> Прочитай код экспорта отчётов и разберись, откуда в CSV берётся время и где
> оно может сдвигаться при переходе на летнее время.

**План:**

> Составь план исправления.
